...
export class LoginPage extends BasePage {
    ...
    async clickShowPasswordButton() {
        ...
        await InteractionWaitHelpers.waitUntilClickable(this.showPasswordButtonLocator);
        await this.showPasswordButtonLocator.click();
    }
    ...
    async login(username: string, password: string) {
        ...
        await InteractionWaitHelpers.waitUntilFillable(this.usernameInputLocator);
        await this.usernameInputLocator.fill(username);
        await InteractionWaitHelpers.waitUntilFillable(this.passwordInputLocator);
        await this.passwordInputLocator.fill(password);
        await InteractionWaitHelpers.waitUntilClickable(this.submitLoginButtonLocator);
        await this.submitLoginButtonLocator.click();
    }
