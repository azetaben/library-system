...
export class BooksPage extends BasePage {
    ...
    getRowActionButton(row: Locator, action: string): Locator {
        return this.bookActionButton(row, action);
    }

    getCatalogControlByLabel(label: string): Locator {
        return this.getControlByExactLabel(label);
    }
    ...
    async clickCatalogControlByLabel(label: string) {
        logger.info(`Clicking catalog control "${label}" via generic locator`);
        await this.clickElement(this.getCatalogControlByLabel(label));
    }
