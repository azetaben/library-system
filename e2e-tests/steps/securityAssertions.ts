...
Then(
    ...
    async function (this: SecurityWorld, dataTable: DataTable) {
...
Then(
    ...
    async function (this: SecurityWorld, _label: string, dataTable: DataTable) {
...
Then(
    'I should see {string} alert',
    async function (this: SecurityWorld, candidateGroup: string) {
        const bodyText = ((await this.pm.getLoginPage().getBodyLocator().textContent()) ?? '').trim();
...
Then(
    ...
    async function (this: SecurityWorld, expectedType: string) {
...
Then(
    ...
    async function (this: SecurityWorld, expectedError: string) {
...
Then(
    ...
    async function (this: SecurityWorld, flag1: string, flag2: string) {
